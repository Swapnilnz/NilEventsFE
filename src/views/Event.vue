            ...
            <div class="p-col-12">
              <div class="box box-stretched">
                <p-card class="img-card" style="width: 100%; height: 100%">
                  <template #header>
                    <img class="event-img" :src="`${eventInfo.eventImage}`" style="height: 45vh" />
                  </template>
                  <template #footer>
                    <div class="img-title" style="padding-bottom: 1vh; font-size: 3vh; text-shadow: 5px 5px 5px black;">
                      {{eventInfo.title}}
                    </div>
                  </template>
                </p-card>
            ...
            <div class="p-col-10" style="height: 28vh">
              <div class="box box-stretched">
                <p-card class="all-attendees-card" style="width: 100%; height: 100%">
                  ...
                  <template #content>
                    <div class="attendees-table" v-if="eventLoaded">
                      <p-table :value="attendees" responsiveLayout="scroll">
                        <p-column field="attendeeId" header="">
                          <template #body="slotProps">
                            <img :src="`${getAttendeeImage(slotProps.data.attendeeId)}`" style="width: 6vh; height:6vh; border-radius: 50%;-webkit-box-shadow: 4px 4px 4px rgba(0,0,0,0.4);"/>
                          </template>
                        </p-column>
              ...
              <div class="p-col-12">
                <div class="box box-stretched">
                  ...
                  <p-card class="user-img-card" style="width: 100%; height: 100%">
                    ...
                    <template #content>
                      <div class="user-img" >
                        <img :src="`${eventInfo.userImage}`" style="-webkit-box-shadow: 4px 4px 4px rgba(0,0,0,0.4);border-radius: 5%; max-width: 38vh; max-height: 22vh"/>
                      </div>
                    </template>
